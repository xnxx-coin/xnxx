    ...
    >
      <Container maxWidth="sm">
        ...
        <Box sx={{display: 'flex', justifyContent: 'center', marginTop: '10px'}}>
          <Link sx={{fontFamily:"verdana", marginRight: '15px'}} href="https://twitter.com/XNXX_SOL" color="inherit" underline="none">
            <Typography variant="body2">Twitter</Typography>
          </Link>
          <Link sx={{fontFamily:"verdan"}} href="https://t.me/xnxx690000" color="inherit" underline="none">
